...
static Entry* findEntry(Entry* entries, int capacity,
                        ObjString* key) {
    // we use modulo to map the key’s hash code to an index within the array’s bounds
...
static void adjustCapacity(Table* table, int capacity) {
    ...
    // fixes the hash addressing (modulos the size)
...
bool tableSet(Table* table, ObjString* key, Value value) {
    ...
    // See: https://craftinginterpreters.com/hash-tables.html#counting-tombstones
...
bool tableDelete(Table* table, ObjString* key) {
    // Replaces with "tombstone"
    // See: https://craftinginterpreters.com/hash-tables.html#deleting-entries
    if (table->count == 0) return false;
...
ObjString* tableFindString(Table* table, const char* chars,
    ...
    // For string interning: https://craftinginterpreters.com/hash-tables.html#string-interning
